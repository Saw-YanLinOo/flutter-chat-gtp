import 'package:chat/app/common/headers.dart';
import 'package:chat/app/modules/chat_image/views/widgets/image_card.dart';
                ...
                child: controller.state.value == ApiState.loading
                    ...
                    : controller.state.value == ApiState.success
                        ? ImageCard(
                            ...
                            onTapCopy: (url) {
                              controller.copyImageUrl(url);
                            },
                            onTapDownload: (url) {
                              controller.saveNetworkImage(url);
                            },
                          )
